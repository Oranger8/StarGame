...
public class GameScreen extends Base2DScreen implements ActionListener {
    ...
    public void paintInfo() {
        ...
        font.draw(batch, sbStage.append("Stage: ").append(emmiter.getStage()), worldBounds.getRight(), worldBounds.getTop(), Align.right);
    }
    ...
    public void update(float delta) {
        ...
        switch (state) {
            case PLAYING:
                ...
                emmiter.generateEnemy(delta, frags);
